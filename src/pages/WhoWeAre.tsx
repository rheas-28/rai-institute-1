      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground mb-6 text-center">Leadership Team</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div key={index} className="p-6 rounded-lg bg-secondary/30 border border-border">
