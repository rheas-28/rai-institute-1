              ...
              <TabsContent value="members" className="animate-fade-up space-y-12">
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-8 items-center justify-items-center">
                    <div className="bg-white p-4 rounded-lg w-32 h-32 flex items-center justify-center hover:shadow-lg transition-all">
                      <img src="https://www.responsible.ai/wp-content/uploads/2024/02/KPMG_NoCP_RGB-150x150.webp" alt="KPMG" className="max-h-24 max-w-full object-contain" />
                    </div>
                    <div className="bg-white p-4 rounded-lg w-32 h-32 flex items-center justify-center hover:shadow-lg transition-all">
                      <img src="https://www.responsible.ai/wp-content/uploads/2023/12/RAII-logos-for-website-29-150x150.webp" alt="IBM" className="max-h-24 max-w-full object-contain" />
                    </div>
                    <div className="bg-white p-4 rounded-lg w-32 h-32 flex items-center justify-center hover:shadow-lg transition-all">
                      <img src="https://www.responsible.ai/wp-content/uploads/2023/12/RAII-logos-for-website-27-150x150.webp" alt="PWC" className="max-h-24 max-w-full object-contain" />
                    </div>
                    <div className="bg-white p-4 rounded-lg w-32 h-32 flex items-center justify-center hover:shadow-lg transition-all">
                      <img src="https://www.responsible.ai/wp-content/uploads/2024/04/Dow-150x150.png" alt="Dow" className="max-h-24 max-w-full object-contain" />
                    </div>
                    <div className="bg-white p-4 rounded-lg w-32 h-32 flex items-center justify-center hover:shadow-lg transition-all">
                      <img src="https://www.responsible.ai/wp-content/uploads/2025/01/logo-cotiviti-2.png" alt="Cotiviti" className="max-h-24 max-w-full object-contain" />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
                    <div className="bg-white p-4 rounded-lg w-32 h-32 flex items-center justify-center hover:shadow-lg transition-all">
                      <img src="https://www.responsible.ai/wp-content/uploads/2023/12/RAII-logos-for-website-25-150x150.webp" alt="Accenture" className="max-h-20 max-w-full object-contain" />
                    </div>
                    <div className="bg-white p-4 rounded-lg w-32 h-32 flex items-center justify-center hover:shadow-lg transition-all">
                      <img src="https://www.responsible.ai/wp-content/uploads/2024/09/Kennedys-150x150.png" alt="Kennedys" className="max-h-20 max-w-full object-contain" />
                    </div>
                  </div>
                </div>
